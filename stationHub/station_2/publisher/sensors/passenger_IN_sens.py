...
class PassengerInSensor:
    ...
    def passenger_counter(self):
        ...
        message = {"address":
                       ["stations", "station_2", "sensors", "passenger_IN"],

                   "data": {
                       "sensor_pass_in_1": {
                           "sensor_name": "passenger_IN_sensor_s2_1",
                           "sensor_id": "pass_IN_sen_id_s2_1",
                           "unit": "int",
                           "sensor_topic": "smartStation/station_2/passenger_IN/pass_IN_1",
